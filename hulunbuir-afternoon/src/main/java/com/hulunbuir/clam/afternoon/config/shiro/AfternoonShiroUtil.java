...
public final class AfternoonShiroUtil {
    ...
    /**
     * 验证密码的正确性,不正确就返回false
     *
     * @author wangjunming
     * @since 2020/3/23 18:05
     */
    public static boolean matches(String usermail, String password, String salt) {
        return !password.equals(encryptPassword(usermail, password, salt));
    }
