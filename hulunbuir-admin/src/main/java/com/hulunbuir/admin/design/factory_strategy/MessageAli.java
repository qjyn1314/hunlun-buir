 ...
 */
@Slf4j
public class MessageAli extends BaseMessage {
    ...
    public void sendMessage(String otherData,String phone,String signatureCode,String messageTemplateCode,String params) {
        ...
        log.info("使用阿里云进行发送短信-->手机号：{}，短信唯一标识：{}，短信内容中的参数：{}，短信内容：{}，短信签名唯一标识：{}，短信签名：{}",phone,messageTemplateCode,params,messageContent,signatureCode,signature);
