...
//        woman.speak();
//        String getCounty = woman.getCounty();
...
//        list.add("asd");
//        list.add("asd");
//        boolean qwe = list.contains("qwe");
//        boolean remove = list.remove("zxc");
//        HashSet<String> hashSet = new HashSet();
//        hashSet.add("asd");
//        boolean asa = hashSet.contains("asa");



        TreeSet<Woman> womanTreeSet = new TreeSet<>();
        womanTreeSet.add(new Woman());
        womanTreeSet.add(new Woman());
        womanTreeSet.add(new Woman());
        womanTreeSet.add(new Woman());
        System.out.println(womanTreeSet);
