layui.define(["form","jquery","authUtils"],function(exports){
    "use strict";
    const form = layui.form, $ = layui.jquery, authUtils = layui.authUtils,Action = layui.authUtils.Action;
    const address = {
            provinces: function () {
                //加载省数据
                var proHtml = '', that = this;
                $.get(Action.ADDRESS_URL, function (data) {
