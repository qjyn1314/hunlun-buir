...
/**
* ${tableComment} 分页查询-${tableComment} ： ${className}PageListPo
*/
@ApiModel("分页查询${className}PageListPo")
public class ${className}PageListPo extends PagePo<${className}PageListVo> implements Serializable {
